#/usr/bin/env python3
"""
Original source from:  https://github.com/JiayangWu/LeetCodeCN-Submissions-Crawler
...
def scraping(client):
    ...
    while True:
        ...
        submissions_url = "https://leetcode-cn.com/api/submissions/?offset=" + str(page_num) + "&limit=2000&lastkey="
